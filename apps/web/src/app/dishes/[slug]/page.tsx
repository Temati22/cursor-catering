...
export async function generateMetadata({ params }: DishPageProps): Promise<Metadata> {
    try {
        ...
        const response = await apiClient.getDishBySlug(slug);
...
export default async function DishPage({ params }: DishPageProps) {
    try {
        ...
        // Prepare breadcrumb items (only for dishes without menu)
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div>
                                ...
                                <div className="flex gap-4">
                                    <button className="bg-[#BFA76F] hover:bg-[#BFA76F]/90 text-white px-8 py-3 rounded-lg font-semibold transition-all shadow-hi hover:shadow-hi-hover">
                                        Заказать блюдо
                                    </button>
