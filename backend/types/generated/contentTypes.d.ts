...
export interface ApiDishDish extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Individual dishes and menu items';
    displayName: 'Dish';
    pluralName: 'dishes';
    singularName: 'dish';
  };
  ...
  attributes: {
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    nutritionalInfo: Schema.Attribute.JSON;
    ...
    type: Schema.Attribute.Enumeration<
      ['cold', 'hot', 'side', 'baked', 'drink', 'sweet', 'other']
    > &
...
export interface ApiEventPageEventPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dishes: Schema.Attribute.Relation<'oneToMany', 'api::dish.dish'>;
    GaleryOfMedia: Schema.Attribute.Component<
      'shared.galereya-dlya-meropriyatiya',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    >;
    menus: Schema.Attribute.DynamicZone<['shared.menus-in-events']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    SeoMenus: Schema.Attribute.DynamicZone<['shared.seo-menu-wrapper']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    TitleInmenu: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiGalleryGallery extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Gallery page with photos';
    displayName: 'Gallery';
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutImage: Schema.Attribute.Media<'images', true>;
    aboutText1: Schema.Attribute.Text;
    aboutText2: Schema.Attribute.Text;
    ...
    imgLogo: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::global.global'
...
export interface ApiMarketingBannerMarketingBanner
  extends Struct.CollectionTypeSchema {
  collectionName: 'marketing_banners';
  info: {
    description: 'Marketing banners with text and image';
    displayName: 'Marketing Banner';
    pluralName: 'marketing-banners';
    singularName: 'marketing-banner';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::marketing-banner.marketing-banner'
    > &
      Schema.Attribute.Private;
    position: Schema.Attribute.Enumeration<
      ['top', 'middle', 'bottom', 'sidebar']
    > &
...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Menu collections for different occasions';
    displayName: 'Menu';
    pluralName: 'menus';
    singularName: 'menu';
  };
  ...
  attributes: {
    ...
    currency: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u0440\u0443\u0431'>;
    description: Schema.Attribute.Text;
    dishes: Schema.Attribute.Relation<'oneToMany', 'api::dish.dish'>;
    ...
    > &
      Schema.Attribute.DefaultTo<'casual'>;
    ...
    > &
      Schema.Attribute.DefaultTo<'gastrobox'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Customer orders for menus';
    displayName: 'Order';
    pluralName: 'orders';
    singularName: 'order';
  };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    GaleryOfMedia: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    Images: Schema.Attribute.Media<
    ...
    > &
      Schema.Attribute.Private;
    Menu: Schema.Attribute.DynamicZone<['shared.menus-in-events']>;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::marketing-banner.marketing-banner': ApiMarketingBannerMarketingBanner;
